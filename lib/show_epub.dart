...
class ShowEpubState extends State<ShowEpub> {
                  ...
                  child: RotatedBox(
                      ...
                      child: SliderTheme(
                          data: SliderThemeData(
                            activeTrackColor:
                                staticThemeId == 4 ? Colors.white : Colors.blue,
                            ...
                            thumbColor: staticThemeId == 4
                                ...
                                : Colors.blue,
                            thumbShape:
                                RoundSliderThumbShape(enabledThumbRadius: 0.r),
                            // Adjust the size of the thumb
                            overlayShape: RoundSliderOverlayShape(
                                overlayRadius:
                                    10.r), // Adjust the size of the overlay
                          ),
                          child: Slider(
  ...
  AnimatedContainer topBar(BuildContext context) {
    return AnimatedContainer(
      ...
      child: Padding(
        ...
        child: AppBar(
          ...
          backgroundColor: backColor,
          shape:
              Border(bottom: BorderSide(color: widget.accentColor, width: 3.h)),
          elevation: 0,
          leading: IconButton(
